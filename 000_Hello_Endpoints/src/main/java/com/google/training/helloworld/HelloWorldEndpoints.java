...
public class HelloWorldEndpoints {
   ...
   // Declare this method as a method available externally through Endpoints
    ...
    @ApiMethod(name = "greetByDay", path = "greetByDay",
            httpMethod = HttpMethod.GET)

    public HelloClass sayHelloAtDay(@Named("name") String name,@Named("period") String period, @Named("day") String day) {
        return new HelloClass(name,period,day);
    }
